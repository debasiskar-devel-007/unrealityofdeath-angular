...
export class UserAddEditComponent {
  ...
  constructor(private apiService: ApiservicesService, public matSnackBar: MatSnackBar, public router: Router, public activateRoute: ActivatedRoute, private location: Location) {  
    ...
    this.userformdata =
    {
      ...
      fields: [

        {
          label: 'First Name',
          name: 'firstname',
          value: this.editFormData && this.editFormData.firstname ? this.editFormData.firstname : '',
          type: 'text',
          classname: 'aaa',
          validations: [
        ...
        },
        {
          label: 'Last Name',
          name: 'lastname',
          value: this.editFormData && this.editFormData.lastname ? this.editFormData.lastname : '',
          type: 'text',
          validations: [
        ...
        },
        {
          label: 'Address',
          name: 'address',
          value: this.editFormData && this.editFormData.address ? this.editFormData.address : '',
          type: 'text',
        ...
        !this.forUpdate && {
          ...
          type: 'password',
          passwordflag: true,
          value: this.editFormData && this.editFormData.password ? this.editFormData.password : '',
          validations: [
        ...
        !this.forUpdate && {
          ...
          type: 'password',
          passwordflag: true,
          value: this.editFormData && this.editFormData.c_password ? this.editFormData.c_password : '',
          validations: [
